...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alternative.name'
        db.add_column('dnstorm_alternative', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Alternative.author'
        db.add_column('dnstorm_alternative', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Idea.slug'
        db.delete_column('dnstorm_idea', 'slug')

        # Adding field 'Vote.value'
        db.add_column('dnstorm_vote', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Alternative.name'
        db.delete_column('dnstorm_alternative', 'name')

        # Deleting field 'Alternative.author'
        db.delete_column('dnstorm_alternative', 'author_id')

        # Adding field 'Idea.slug'
        db.add_column('dnstorm_idea', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', max_length=60, unique_with=(), unique=True, populate_from='title'),
                      keep_default=False)

        # Deleting field 'Vote.value'
        db.delete_column('dnstorm_vote', 'value')
