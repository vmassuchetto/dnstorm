...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Idea.cost'
        db.delete_column('dnstorm_idea', 'cost')

        # Deleting field 'Idea.deadline'
        db.delete_column('dnstorm_idea', 'deadline')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Idea.cost'
        db.add_column('dnstorm_idea', 'cost',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Idea.deadline'
        db.add_column('dnstorm_idea', 'deadline',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
