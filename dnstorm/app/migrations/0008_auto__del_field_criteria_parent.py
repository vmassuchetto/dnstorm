...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Criteria.parent'
        db.delete_column('dnstorm_criteria', 'parent_id')


    def backwards(self, orm):
        # Adding field 'Criteria.parent'
        db.add_column('dnstorm_criteria', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Criteria'], null=True, blank=True),
                      keep_default=False)
