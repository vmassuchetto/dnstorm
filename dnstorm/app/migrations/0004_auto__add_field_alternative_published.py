...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field coauthor on 'Criteria'
        db.delete_table(db.shorten_name('dnstorm_criteria_coauthor'))
        ...
        db.rename_table('dnstorm_problem_collaborator', 'dnstorm_problem_contributor')
