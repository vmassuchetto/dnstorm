...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Alternative.updated'
        db.add_column('dnstorm_alternative', 'updated',
        ...
        db.delete_column('dnstorm_comment', 'deleted_by_id')

        # Adding field 'Vote.updated'
        db.add_column('dnstorm_vote', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default='2000-01-01', auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Problem.open'
        db.add_column('dnstorm_problem', 'open',
    ...
    def backwards(self, orm):
        # Deleting field 'Alternative.updated'
        db.delete_column('dnstorm_alternative', 'updated')

        # Adding field 'Idea.deleted_by'
        db.add_column('dnstorm_idea', 'deleted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='idea_deleted_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Removing M2M table for field coauthor on 'Idea'
        db.delete_table(db.shorten_name('dnstorm_idea_coauthor'))

        # Adding field 'Comment.deleted_by'
        db.add_column('dnstorm_comment', 'deleted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='comment_deleted_by', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Vote.updated'
        db.delete_column('dnstorm_vote', 'updated')

        # Deleting field 'Problem.open'
        db.delete_column('dnstorm_problem', 'open')
